...
export const getFavouriteComic = PromiseContent.fromAsyncFunction((page: number, sort: BKSortType, signal?: AbortSignal) => createClassFromResponseStream(picapiRest.get<{ comics: RawStream<RawLessComic> }>(`/users/favourite?s=${sort}&page=${page}`, { signal }), LessComic))

export const createFavouriteComicStream = (sort: BKSortType) =>
