...
export namespace _jmApiAuth {
  ...
  export const signUp = PromiseContent.fromAsyncFunction((data: JmType.auth.SignupData, signal?: AbortSignal) => importJm(jm => jm.api.rest.post('/register', undefined, { signal, params: data })))
}