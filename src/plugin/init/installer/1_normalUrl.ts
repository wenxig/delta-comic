...
export class _PluginInstallByNormalUrl extends PluginInstaller {
  ...
  public override async install(input: string): Promise<PluginArchiveMeta> {
  ...
  public override async update(pluginMeta: PluginArchiveMeta): Promise<PluginArchiveMeta> {
